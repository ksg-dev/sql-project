...
///Brings up TrackId and income total///
SELECT	TrackId,
...
///Not quite right - AmountSpent gathering all receipts, not just those for Iron Maiden///
	SELECT	ar.Name,
...
*using WHERE did not work either



Right Answer! Which Customer spent the most on Iron Maiden (top artist found in above solution)
...
Q2 - On average, how many tracks have artists sold in the Rock genre?

SELECT	AVG(t1.Track_Count) AS Average
FROM	(
...
Q4 - Which top 5 customers have spent the most total, and how many tracks did they purchase?
...
FROM	(
	SELECT DISTINCT	c.CustomerId AS CustId,
